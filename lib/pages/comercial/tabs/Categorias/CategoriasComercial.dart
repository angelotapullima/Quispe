...
class CategoriasComercial extends StatefulWidget {
  const CategoriasComercial({Key? key}) : super(key: key);

  @override
  _CategoriasComercialState createState() => _CategoriasComercialState();
}

class _CategoriasComercialState extends State<CategoriasComercial> with SingleTickerProviderStateMixin {
